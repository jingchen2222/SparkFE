...
import com._4paradigm.hybridsql.sparkfe.utils.{ConfigOption, ConfigReflections}
...
class SparkFeConfig extends Serializable {
  ...
  @ConfigOption(name="sparkfe.slowRunCacheDir", doc="""
      | Slow run mode cache directory path. If specified, run sparkfe plan with slow mode.
